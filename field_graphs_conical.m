...
if plot_field_region_1==1 && plot_field_region_2==1 && plot_field_region_3==1
    ...
    axis([-size_region_1*thickness_total (1+size_region_1)*thickness_total x_min*1e6 x_max*1e6])
...
elseif plot_field_region_1==2 && plot_field_region_2==1 && plot_field_region_3==2 % již změněno
    total_axis_z=z_22;
...
%% pridal jsem JS
lim = caxis;
caxis([-max(abs(lim)) max(abs(lim))])
colormap(meepcolormap)
%%
