...
layer_1=[thickness_gold_wire,0,gold,wire_width,n_3,wire_width+(width_AR_gap/2),chromium,Lambda-(width_AR_gap/2),n_3,Lambda]; % user's layer
layer_2=[thickness_layer,0,n_layer,wire_width,n_3,wire_width+(width_AR_gap/2),chromium,Lambda-(width_AR_gap/2),n_3,Lambda]; % user's layer
layer_3=[thickness_AR_layer-thickness_gold_wire-thickness_layer,0,n_3,wire_width+(width_AR_gap/2),chromium,Lambda-(width_AR_gap/2),n_3,Lambda]; % user's layer
