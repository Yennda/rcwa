...
layer_1=[wire_height,0,gold,wire_width,n_layer,wire_width+thickness_layer,n_3,Lambda-thickness_layer,n_layer,Lambda]; % user's layer
layer_2=[thickness_layer,0,n_layer,wire_width+thickness_layer,n_3,Lambda-thickness_layer,n_layer,Lambda]; % user's layer
