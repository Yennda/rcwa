...
layer_2=add_sin_layer(Lambda,Lambda,amplitude,gold, n_resist,20);
layer_3=add_hom_layer(Lambda,depth-amplitude,gold);

% layer_3=add_sin_layer(Lambda,Lambda,depth,ns,gold,20);
% layer_4=add_hom_layer(Lambda,dn_layer_thickness,ns);
layer_4=add_sin_layer(Lambda,Lambda,amplitude,n_water,gold,20);

layer_5=add_hom_layer(Lambda,dn_layer_thickness,n3 + dn);
