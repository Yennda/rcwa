...
Lambda=0.527; % grating period [um] (exception grating=10)
...
measurement=1; % measurement 1 --- check studying_order
...
switch measurement
    ...
    case 1
        ...
        maximum_number_of_orders=301; % only odd number
        step=2; % step=2 
    case 2 %
        minimum_wavelength=0.64; %um
        maximum_wavelength=0.72; %um
        step=0.001;   
    case 3 % 
        minimum_thickness=0.001; %um
        maximum_thickness=0.01; %um
        step=0.001;
    case 4
        minimum_index=1; 
        maximum_index=3; 
