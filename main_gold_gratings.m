...
thickness_total=0.025; % total thickness [um] (exception grating=10)
...
% ng=1.33; % Groove indicies, disabled when grating=10
...
switch grating
    ...
    case 10 % arbitrary grating from file
        ...
        input_grating_file='grating_prism_excitation.m';     
...
switch measurement
    ...
    case 1
        ...
        maximum_number_of_orders=401; % only odd number
        step=10; % step=2 
    case 2 %
        minimum_wavelength=0.700; %um
        maximum_wavelength=0.800; %um
        step=0.001;   
    case 3 % 
